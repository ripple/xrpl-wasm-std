...
use crate::core::types::hash_160::Hash160;
...
pub fn get_instance_param<T: InstParamBytes>(index: i32) -> Result<T, ParamError> {
    ...
    let result = unsafe { instance_param(index, T::type_code(), buf.as_mut_ptr(), byte_size) };
...
impl InstParamBytes for Hash160 {
    fn type_code() -> i32 {
        STI_UINT160.into()
    }
    fn byte_size() -> usize {
...
impl InstParamBytes for Hash192 {
    fn type_code() -> i32 {
        STI_UINT192.into()
    }
    fn byte_size() -> usize {
...
impl InstParamBytes for Amount {
    fn type_code() -> i32 {
        STI_AMOUNT.into()
    }
    fn byte_size() -> usize {
