...
use crate::core::types::blob::{Blob, DEFAULT_BLOB_SIZE, DOMAIN_BLOB_SIZE};
...
pub const PublicKey: SField<Blob<{ DEFAULT_BLOB_SIZE }>, 458753> = SField::new();
pub const MessageKey: SField<Blob<{ PUBLIC_KEY_BUFFER_SIZE }>, 458754> = SField::new();
pub const SigningPubKey: SField<Blob<{ DEFAULT_BLOB_SIZE }>, 458755> = SField::new();
...
pub const MemoType: SField<Blob<{ DEFAULT_BLOB_SIZE }>, 458764> = SField::new();
pub const MemoData: SField<Blob<{ DEFAULT_BLOB_SIZE }>, 458765> = SField::new();
pub const MemoFormat: SField<Blob<{ DEFAULT_BLOB_SIZE }>, 458766> = SField::new();
