...
pub extern "C" fn function_params() -> i32 {
    ...
    // AMOUNT XRP
    let xrp_token = match get_function_param::<Amount>(10) {
        Ok(a) => a,
        Err(err) => {
    ...
    // AMOUNT IOU
    let iou_token = match get_function_param::<Amount>(11) {
        Ok(a) => a,
        Err(err) => {
...
pub extern "C" fn instance_params() -> i32 {
    ...
    // UINT160
    let value = match get_instance_param::<Hash160>(6) {
        Ok(a) => a,
        Err(err) => {
            let _ = trace_num("UINT160 Parameter Error Code:", err as i64);
            return -1;
    ...
    // UINT192
    let value = match get_instance_param::<Hash192>(7) {
        Ok(a) => a,
        Err(err) => {
            let _ = trace_num("UINT192 Parameter Error Code:", err as i64);
            return -1;
    ...
    // AMOUNT XRP
    let xrp_token = match get_instance_param::<Amount>(11) {
        Ok(a) => a,
        Err(err) => {
            let _ = trace_num("AMOUNT XRP Parameter Error Code:", err as i64);
            return -1;
    ...
    // AMOUNT IOU
    let iou_token = match get_instance_param::<Amount>(12) {
        Ok(a) => a,
        Err(err) => {
            let _ = trace_num("AMOUNT IOU Parameter Error Code:", err as i64);
            return -1;
