...
echo "  - $PROJECT_ROOT/gas_benchmark_results.json"
echo "  - $PROJECT_ROOT/GAS_BENCHMARK_REPORT.md"
echo ""
echo "To compare with main branch, run:"
echo "  git stash"
echo "  node $TOOLS_DIR/gas_benchmark.js --branch main"
echo "  git stash pop"
echo "  node $TOOLS_DIR/compare_gas_results.js"
